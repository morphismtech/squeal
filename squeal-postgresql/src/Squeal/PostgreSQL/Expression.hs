...
-- "NULL"
null_ :: Expression tables grouping params (constraints :=> 'Null ty)
...
-- "TRUE"
unNull
  :: Expression tables grouping params (constraints :=> 'NotNull ty)
  -- ^ not @NULL@
  -> Expression tables grouping params (constraints :=> 'Null ty)
