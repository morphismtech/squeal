...
>>> printSQL (select Star (from (jsonEach (inPG (Json (object ["a" .= "foo", "b" .= "bar"]))))))
...
>>> printSQL (select Star (from (jsonbEach (inPG (Jsonb (object ["a" .= "foo", "b" .= "bar"]))))))
...
>>> printSQL (select Star (from (jsonEachText (inPG (Json (object ["a" .= "foo", "b" .= "bar"]))))))
...
>>> printSQL (select Star (from (jsonbEachText (inPG (Jsonb (object ["a" .= "foo", "b" .= "bar"]))))))
...
>>> printSQL (jsonObjectKeys (inPG (Json (object ["a" .= "foo", "b" .= "bar"]))))
...
>>> printSQL (jsonbObjectKeys (inPG (Jsonb (object ["a" .= "foo", "b" .= "bar"]))))
